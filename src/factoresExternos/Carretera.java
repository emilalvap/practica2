...
public class Carretera 
{
	...
	int matriz[];
	/**
	 * recibe la direccion de la ruta en la que se encuentra el fichero de carretera
	 * @param miruta
	 */
	 ...
	 * matriz[0] = metro en el que cambia la pendiente
	 * matriz[1] =pendiente que ira desde 90 hasta -90
	*/
